...
impl <C: TThriftClient + TSimpleServiceSyncClientMarker> TSimpleServiceSyncClient for C {
  fn hello(&mut self, name: String) -> thrift::Result<String> {
    (
      {
        ...
        let call_args = SimpleServiceHelloArgs { name };
    ...
    )?;
    {
      ...
      let result = SimpleServiceHelloResult::read_from_in_protocol(self.i_prot_mut())?;
      self.i_prot_mut().read_message_end()?;
      result.ok_or()
    }
  }
...
impl TSimpleServiceProcessFunctions {
  pub fn process_hello<H: SimpleServiceSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let args = SimpleServiceHelloArgs::read_from_in_protocol(i_prot)?;
    match handler.handle_hello(args.name) {
      Ok(handler_return) => {
        ...
        let ret = SimpleServiceHelloResult { result_value: Some(handler_return) };
...
//
// SimpleServiceHelloArgs
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SimpleServiceHelloArgs {
  name: String,
}

impl SimpleServiceHelloArgs {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<SimpleServiceHelloArgs> {
    ...
    verify_required_field_exists("SimpleServiceHelloArgs.name", &f_1)?;
    let ret = SimpleServiceHelloArgs {
...
//
// SimpleServiceHelloResult
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct SimpleServiceHelloResult {
  result_value: Option<String>,
}

impl SimpleServiceHelloResult {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<SimpleServiceHelloResult> {
    i_prot.read_struct_begin()?;
    ...
    i_prot.read_struct_end()?;
    let ret = SimpleServiceHelloResult {
      result_value: f_0,
    };
    Ok(ret)
  }
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("SimpleServiceHelloResult");
    o_prot.write_struct_begin(&struct_ident)?;
      ...
      Err(
        thrift::Error::Application(
          ApplicationError::new(
            ...
            "no result received for SimpleServiceHello"
          )
        )
      )
    }
